...
<br>
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-lg-8 mx-auto">
          ...
          <form action="add_mahasiswa.php" method="post" novalidate="novalidate" entype = "multipart/form-data">
            ...
            <div class="control-group">
              <div class="form-group floating-label-form-group controls mb-0 pb-2">
                ...
                <input class="form-control" id="tanggal_lahir" name="tanggal_lahir" type="text" placeholder="Masukkan Tanggal Lahir" required="required">
    <p class="help-block text-danger"></p>
              </div>
            </div>
   <div class="control-group">
              <div class="form-group floating-label-form-group controls mb-0 pb-2">
                ...
                <input class="form-control" id="id_program_studi" name="id_program_studi" type="text" placeholder="Masukkan ID Program Studi" required="required">
    <p class="help-block text-danger"></p>
              </div>
            </div>
            <div.class="control-group">
            ...
            <?php
            while ($data_program_studi = mysqli_fecth_array($result_program_studi))
            {
 ...
 <?php 
  ...
  if (isset($_POST['Submit'])){
   ...
   $result = mysqli_query($connection, "INSERT INTO mahasiswa(nrp,nama,prodi,tanggal_lahir,id_program_studi) VALUES('$nrp','$nama','$prodi','$tanggal_lahir',
   '$id_program_studi')");
